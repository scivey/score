...
#include "aliens/vendored/seastar/core/temporary_buffer.hh"
...
// SI 8-2016 : hash function here changed
// to avoid std::experimental::string_view


namespace std {

template <typename char_type, typename size_type, size_type max_size>
struct hash<aliens::vendored::seastar::basic_sstring<char_type, size_type, max_size>> {
    using sstring_type = aliens::vendored::seastar::basic_sstring<
      char_type, size_type, max_size
    >;
    size_t operator()(const sstring_type& s) const {
        // return std::hash<std::experimental::basic_string_view<char_type>>()(s);
        return std::hash<char_type*>()(s.c_str());
    }
};
