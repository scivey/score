...
class ByteStringView {
 ...
 public:
  ByteStringView(const value_type *start, const value_type *end)
    : start_(start), end_(end) {}

  ByteStringView(const value_type *start, size_type offset)
    : start_(start), end_(start + offset) {}

  ByteStringView(const std::string &text, size_type start, size_type end)
    : start_(text.data() + start), end_(text.data() + end) {}

  ByteStringView(const std::string &text)
