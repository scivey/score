...
#include "score/vendored/folly/detail/Malloc.h"
#include "score/vendored/folly/portability/BitsFunctexcept.h"
...
#define SCORE_FOLLY_HAVE_MALLOC_H 1

#else // !defined(_LIBSTDCXX_FBSTRING)

#include "score/vendored/folly/detail/Malloc.h" /* nolint */
#include "score/vendored/folly/portability/BitsFunctexcept.h" /* nolint */
...
#define SCORE_FOLLY_MALLOC_NOINLINE __attribute__((__noinline__))
#else
#define SCORE_FOLLY_MALLOC_NOINLINE
#endif
...
inline bool usingJEMalloc() noexcept {
  ...
  static const bool result = [] () SCORE_FOLLY_MALLOC_NOINLINE noexcept {
