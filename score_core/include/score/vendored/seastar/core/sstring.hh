...
#include "score/vendored/seastar/core/temporary_buffer.hh"
...
template <typename char_type, typename size_type, size_type max_size>
struct hash<score::vendored::seastar::basic_sstring<char_type, size_type, max_size>> {
    using sstring_type = score::vendored::seastar::basic_sstring<
