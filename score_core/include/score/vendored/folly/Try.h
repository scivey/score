...
#include "score/vendored/folly/Memory.h"
#include "score/vendored/folly/Portability.h"
#include "score/vendored/folly/Unit.h"
...
class Try {
 ...
 public:
   ...
   */
  SCORE_FOLLY_DEPRECATED("use Try(exception_wrapper)")
...
#include "score/vendored/folly/Try-inl.h"
